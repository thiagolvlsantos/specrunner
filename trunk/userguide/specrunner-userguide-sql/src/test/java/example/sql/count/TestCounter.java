...
import org.specrunner.sql.database.impl.DatabaseCountListener;
...
public class TestCounter {
    ...
    public void configurar(IConfiguration cfg) {
        ...
        cfg.add(PluginSchema.FEATURE_SOURCE, "/example/sql/count/value.cfg.xml");
        ...
        cfg.add(IDatabase.FEATURE_LISTENERS, Arrays.asList(new DatabaseCountListener()));
    }
}