...
import org.specrunner.browser.AbstractPluginBrowserAware;
...
public class PluginView extends AbstractPluginBrowserAware implements IAction {
    ...
    protected void doEnd(IContext context, IResultSet result, WebClient client) throws PluginException {
        result.addResult(Status.SUCCESS, context.peek(), new WritablePage(client.getCurrentWindow().getEnclosedPage()));
    }
}
