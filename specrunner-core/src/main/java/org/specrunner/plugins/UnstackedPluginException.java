...
public class UnstackedPluginException extends PluginException implements UnstackedException {
    ...
    public UnstackedPluginException(String message) {
        super(message);
    }

    public UnstackedPluginException(Throwable cause) {
        super(cause);
    }

    public UnstackedPluginException(String message, Throwable cause) {
        super(message, cause);
    }
}
// CHECKSTYLE:ON
