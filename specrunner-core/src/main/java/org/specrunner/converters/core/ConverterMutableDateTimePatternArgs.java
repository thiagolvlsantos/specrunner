...
/**
 * Convert any date (MutableDateTime form Jodatime), given a provided pattern in
 * arg[0].
 * 
...
public class ConverterMutableDateTimePatternArgs extends AbstractConverterTimezone<MutableDateTime> {
    /**
     * Cache of formatters.
     */
    protected static ICache<String, DateTimeFormatter> cache = SRServices.get(ICacheFactory.class).newCache(ConverterMutableDateTimePatternArgs.class.getName());
