...
public class ConverterLocalTimeCurrentTemplate extends AbstractConverterTimeTemplate<LocalTime> {
     ...
     *            Value.
     */
    public ConverterLocalTimeCurrentTemplate(List<String> values) {
        super(values);
    ...
    @Override
    protected LocalTime postProcess(Object value, Object[] args, LocalTime result) {
