...
import org.specrunner.plugins.impl.elements.AbstractPluginResources;
...
public class TestGreeter {
    ...
    public void testGreeter() {
        ...
        cfg.add(AbstractPluginResources.FEATURE_SAVE, false);
        SpecRunnerJUnit.defaultRun("src/test/resources/income/HelloWorld.html", cfg);
    }

    @Test
    public void testGreeterImages() {
        SpecRunnerServices.get(IFeatureManager.class).put(AbstractPluginResources.FEATURE_SAVE, true);
